...
val Color.Companion.IconBackGround get() = Gray.copy(alpha = 0.5f)
...
val Color.Companion.PrimaryTextColor get() = White

val Color.Companion.SecondaryTextColor get() = LightGray

val Color.Companion.SmallTextColor get() = Gray
